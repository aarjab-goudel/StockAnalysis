...
public enum ISSheetConstants {
	NUM_COLUMNS(17), IS_DATE(4), CURRENCY_TYPE(5), REVENUE_COLUMN(6), REVENUE_GROWTH_COLUMN(7),
	...
	RESEARCH_AND_DEVELOPMENT_COLUMN(14), RESEARCH_AND_DEVELOPMENT_GROWTH_COLUMN(15), LAST_COLUMN(16);
